...
if($_POST['ok_item_1_price'] != round($h->money->convert($order->total_price, $method->currency_id, false), 2) || $_POST['ok_item_1_price']<=0)
...
{
	header('Location: '.$h->request->root_url.'/order/');
	exit();
}
