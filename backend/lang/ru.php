...
$backend_translations->banner_instruction2 = 'Для перелистывания баннеров вставьте следующий скрипт js в шаблоне';
...
$backend_translations->translation_not_allowed = 'Переменная с именем не допустима!';
...
$backend_translations->general_access = 'Не доступно';
...
$backend_translations->import_info = 'При загрузке файла импорта система автоматически считывает все поля (колонки) из файла.
 ...
 <br>Кликнув по надписи в столбце "Поля системы" вы можете самостоятельно указать, чему будет соответствовать колонка из файла';
...
$backend_translations->pro_only_title = 'Данный функционал не доступен';
