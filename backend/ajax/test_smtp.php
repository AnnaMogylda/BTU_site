<?php
    ...
    $host     = $h->settings->smtp_server = $h->request->post('server');
    $port     = $h->settings->smtp_port   = $h->request->post('port');
    $username = $h->settings->smtp_user   = $h->request->post('user');
    $password = $h->settings->smtp_pass   = $h->request->post('pass');
    $result   = array(
        'status'  => false,
        'message' => '',
        'trace'   => ''
