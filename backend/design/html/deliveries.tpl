        ...
        <form class="fn_form_list" method="post">
            <div class="h_list products_list fn_sort_list">
                ...
                <div class="h_list_head">
                    ...
                    <div class="h_list_heading h_list_delivery_photo">{$btr->general_image|escape}</div>
                    <div class="h_list_heading h_list_delivery_name">{$btr->general_name|escape}</div>
                    <div class="h_list_heading h_list_delivery_condit">{$btr->general_conditions|escape}</div>
                    <div class="h_list_heading h_list_status">{$btr->general_enable|escape}</div>
                    <div class="h_list_heading h_list_close"></div>
                </div>

                {*Параметры элемента*}
                <div class="deliveries_wrap h_list_body sortable">
                            ...
                            <div class="h_list_row">
                               <input type="hidden" name="positions[{$delivery->id}]" value="{$delivery->position}">
                                ...
                                <div class="h_list_boding h_list_check">
                                    ...
                                    <label class="h_ckeckbox" for="id_{$delivery->id}"></label>
                                </div>

                                <div class="h_list_boding h_list_delivery_photo">
                                    {if $delivery->image}
                                ...
                                <div class="h_list_boding h_list_delivery_name">
                                    <a href="{url module=DeliveryAdmin id=$delivery->id return=$smarty.server.REQUEST_URI}">
                                ...
                                <div class="h_list_boding h_list_delivery_condit">
                                    {if $delivery->separate_payment}
                                        <div><span class="tag tag-primary">{$btr->general_paid_separately|escape}</span></div>
                                    {/if}
                                    {if $delivery->price > 0}
