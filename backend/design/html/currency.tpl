                ...
                <div class="h_list">
                    <div class="currencies_wrap clearfix">
                        ...
                        <div class="h_list_head">
                            <div class="h_list_heading h_list_drag"></div>
                            <div class="h_list_heading h_list_currency_num">ID</div>
                            <div class="h_list_heading h_list_currency_name">{$btr->currency_name|escape}</div>
                            <div class="h_list_heading h_list_currency_sign">{$btr->currency_symbol|escape}</div>
                            <div class="h_list_heading h_list_currency_iso">{$btr->currency_iso|escape}</div>
                            <div class="h_list_heading h_list_currency_exchange">{$btr->currency_rate|escape}</div>
                            <div class="h_list_heading h_list_status hidden-md-down">{$btr->general_enable|escape}</div>
                            <div class="h_list_heading cur_settings">{$btr->general_activities|escape}</div>
                            <div class="h_list_heading h_list_close"></div>
                        </div>
                        {*Параметры элемента*}
                        <div id="currencies_block" class="h_list_body sortable">
                            {foreach $currencies as $c}
                                <div class="h_list_body_item">
                                    <div class="h_list_row">
                                        ...
                                        <div class="h_list_boding h_list_currency_num">
                                            <span>{$c->id}</span>
                                        </div>
                                        <div class="h_list_boding h_list_currency_name">
                                            ...
                                            <div class="hidden-md-up mt-q">
                                                <div class="h_list_currency_exchange_item">
                                                    {if !$c@first}
                                        ...
                                        {/if}
                                        <div class="h_list_boding h_list_status hidden-md-down">
                            ...
                            <div id="new_currency" class="h_list_body sortable" style="display: none">
                                <div class="h_list_body_item">
                                    <div class="h_list_row">
                                        <div class="h_list_boding h_list_drag move_zone">
                                            {include file='svg_icon.tpl' svgId='drag_vertical'}
                                        </div>
                                        <div class="h_list_boding h_list_currency_num"></div>
                                        <div class="h_list_boding h_list_currency_name">
                                        ...
                                        <div class="h_list_setting cur_settings"></div>
                                        <div class="h_list_boding h_list_close"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="action" class="h_list_footer">
                            <div class="h_list_foot_left"></div>
