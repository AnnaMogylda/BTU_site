        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form class="fn_form_list" method="post">
                    ...
                    <div class="orders_list h_list products_list">
                        {*Шапка таблицы*}
                        <div class="h_list_head">
                            ...
                            <div class="h_list_heading h_list_order_number">№ </div>
                            <div class="h_list_heading h_list_orders_name">{$btr->general_full_name|escape}</div>
                            <div class="h_list_heading h_list_order_status">{$btr->general_status|escape}</div>
                            <div class="h_list_heading h_list_order_product_count">{$btr->general_products|escape}</div>
                            <div class="h_list_heading h_list_orders_price">{$btr->general_sales_amount}</div>
                            <div class="h_list_heading h_list_order_marker">{$btr->orders_label|escape}</div>
                            <div class="h_list_heading h_list_close"></div>
                        </div>
                        {*Параметры элемента*}
                        <div class="h_list_body">
                            {foreach $orders as $order}
                            <div class="fn_row h_list_body_item " style="border-left: 5px solid #{$order->status_color};">
                                <div class="h_list_row">
                                    <div class="h_list_boding h_list_check">
                                        ...
                                        <label class="h_ckeckbox" for="id_{$order->id}"></label>
                                    </div>

                                    <div class="h_list_boding h_list_order_number">
                                    ...
                                    <div class="h_list_boding h_list_orders_name">
                                    ...
                                    <div class="h_list_boding h_list_order_status">
                                        {$orders_status[$order->status_id]->name|escape}
                                    </div>

                                    <div class="h_list_boding h_list_order_product_count">
                                    ...
                                    <div class="h_list_boding h_list_orders_price">
                                        <div class="input-group">
                                    ...
                                    <div class="h_list_boding h_list_order_marker">
                        ...
                        <div class="h_list_footer">
                            <div class="h_list_foot_left">
                                ...
                                <div class="h_list_option fn_show_label" style="display: none">
                                ...
                                <div class="h_list_option fn_show_status" style="display: none;">
