                ...
                <div class="toggle_body_wrap on fn_card fn_sort_list">
                    ...
                    <div class="h_list ok_related_list">
                        <div class="h_list_head">
                            <div class="h_list_heading feature_value_name">{$btr->feature_value_name}</div>
                            <div class="h_list_heading feature_value_translit">{$btr->feature_value_translit}</div>
                            <div class="h_list_heading feature_value_products_num">{$btr->feature_value_products_num}</div>
                            <div class="h_list_heading feature_value_index">
                        ...
                        <div class="h_list_body fn_feature_values_list sort_extended fn_values_list">
                            {foreach $features_values as $fv}
                                <div class="fn_row h_list_body_item fn_sort_item">
                                    <div class="h_list_row">
                                        ...
                                        <div class="h_list_boding feature_value_name">
                                        ...
                                        <div class="h_list_boding feature_value_translit">
                                        ...
                                        <div class="h_list_boding feature_value_products_num">
                                        ...
                                        <div class="h_list_boding feature_value_index">
                            ...
                            <div class="fn_row h_list_body_item fn_sort_item fn_new_value" style="display: none;">
                                <div class="h_list_row">
