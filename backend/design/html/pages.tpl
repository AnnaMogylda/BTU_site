                ...
                <form id="list_form" method="post" class="fn_form_list fn_fast_button">
                    ...
                    <div class="pages_wrap h_list">
                        ...
                        <div class="h_list_head">
                            ...
                            <div class="h_list_heading h_list_page_name">{$btr->pages_name|escape}</div>
                            <div class="h_list_heading h_list_pages_group"></div>
                            <div class="h_list_heading h_list_status">{$btr->general_enable|escape}</div>
                            <div class="h_list_heading h_list_setting h_list_pages_setting">{$btr->general_activities|escape}</div>
                            <div class="h_list_heading h_list_close"></div>
                        </div>

                        {*Параметры элемента*}
                        <div id="sortable" class="h_list_body sortable">
                                ...
                                <div class="fn_row h_list_body_item">
                                    <div class="h_list_row">
                                        ...
                                        <div class="h_list_boding h_list_check">
                                            ...
                                            <label class="h_ckeckbox" for="id_{$page->id}"></label>
                                        </div>

                                        <div class="h_list_boding h_list_page_name">
                                            <a href="{url module=PageAdmin id=$page->id return=$smarty.server.REQUEST_URI}">
                                                {$page->name|escape}
                                            </a>
                                        </div>

                                        <div class="h_list_boding h_list_pages_group">
                                        </div>
                                        ...
                                        <div class="h_list_setting h_list_pages_setting">
                                            {*open*}
