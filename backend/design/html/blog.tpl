                ...
                <form class="fn_form_list fn_fast_button" method="post">
                    ...
                    <div class="post_wrap h_list">
                        ...
                        <div class="h_list_head">
                            ...
                            <div class="h_list_heading h_list_blog_name">{$btr->blog_name|escape}</div>
                            <div class="h_list_heading h_list_blog_type">{$btr->blog_type|escape}</div>
                            <div class="h_list_heading h_list_status">{$btr->general_enable|escape}</div>
                            <div class="h_list_heading h_list_setting h_list_blog_setting">{$btr->general_activities|escape}</div>
                                ...
                                <div class="fn_row h_list_body_item">
                                    <div class="h_list_row">
                                        ...
                                        <div class="h_list_boding h_list_check">
                                            ...
                                            <label class="h_ckeckbox" for="id_{$post->id}"></label>
                                        </div>
                                        ...
                                        <div class="h_list_boding h_list_blog_name">
                                        ...
                                        <div class="h_list_boding h_list_blog_type">
                                            {if $post->type_post == "blog"}
                                                <div class="tag tag-warning">{$btr->blog_articles|escape}</div>
                                                {else}
                                                <div class="tag tag-info">{$btr->blog_one_news|escape}</div>
                                        ...
                                        <div class="h_list_setting h_list_blog_setting">
                                            {*open*}
