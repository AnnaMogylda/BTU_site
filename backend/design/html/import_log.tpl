                ...
                <form method="post">
                    ...
                    <div class="h_list">
                        ...
                        <div class="h_list_head">
                           ...
                           <div class="h_list_heading h_list_log_name">{$btr->general_name|escape} </div>
                            <div class="h_list_heading h_list_log_status">
                            ...
                            {foreach $logs as $log}
                                <div class="fn_row h_list_body_item">
                                    <div class="h_list_row">
                                        <div class="h_list_boding h_list_check">{$log@iteration}</div>
                                        ...
                                        <div class="h_list_boding h_list_log_name">
                                        ...
                                        <div class="h_list_boding h_list_log_status">
                                            {if $log->status == 'added'}
