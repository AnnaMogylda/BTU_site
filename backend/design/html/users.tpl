                ...
                <form class="fn_form_list" method="post">
                    ...
                    <div class="users_wrap h_list products_list fn_sort_list">
                        <div class="h_list_head">
                            ...
                            <div class="h_list_heading h_list_users_group">{$btr->general_group|escape}</div>
                            <div class="h_list_heading h_list_count">
                        ...
                        {*Параметры элемента*}
                        <div class="h_list_body sortable">
                                ...
                                <div class="fn_row h_list_body_item fn_sort_item">
                                    <div class="h_list_row ">
                                        <div class="h_list_boding h_list_check">
                                            ...
                                            <label class="h_ckeckbox" for="id_{$user->id}"></label>
                                        </div>

                                        <div class="h_list_boding h_list_users_name">
                                            <a href="{url module=UserAdmin id=$user->id}">
                                                {$user->name|escape}
                                            </a>
                                        </div>

                                        <div class="h_list_boding h_list_users_email">
                                            <a href="mailto:{$user->name|escape}<{$user->email|escape}>">
                                                {$user->email|escape}
                                            </a>
                                        </div>

                                        <div class="h_list_boding h_list_users_date">
                                            {$user->created|date} | {$user->created|time}
                                        </div>

                                        <div class="h_list_boding h_list_users_group">
                        ...
                        <div class="h_list_footer fn_action_block">
                            <div class="h_list_foot_left">
                                ...
                                <div id="move_to" class="h_list_option hidden fn_hide_block">
