        ...
        <div class="col-lg-12 col-md-12 ">
            <div class="boxed fn_toggle_wrap match_matchHeight_true">
                ...
                <div class="variants_wrapper fn_card">
                    <div class="h_list variants_list scrollbar-variant">
                        <div class="h_list_body sortable variants_listadd">
                            {foreach $product_variants as $variant}
                                <div class="h_list_body_item variants_list_item ">
                                    <div class="h_list_row">
                                        <div class="h_list_boding variants_item_drag">
                                            <div class="heading_label"></div>
                                            <div class="move_zone">
                                                {include file='svg_icon.tpl' svgId='drag_vertical'}
                                            </div>
                                        </div>
                                        <div class="h_list_boding variants_item_sku">
                                        ...
                                        <div class="h_list_boding variants_item_name">
                                        ...
                                        <div class="h_list_boding variants_item_price">
                                        ...
                                        <div class="h_list_boding variants_item_discount">
                                        ...
                                        <div class="h_list_boding variants_item_currency">
                                        ...
                                        <div class="h_list_boding variants_item_weight">
                                        ...
                                        <div class="h_list_boding variants_item_amount">
                                        ...
                                        <div class="h_list_boding variants_item_units">
                                    ...
                                    <div class="h_list_row">
                                        <div class="h_list_boding variants_item_drag"></div>
                                        <div class="h_list_boding variants_item_yandex">
                                            <div class="h_switch clearfix">
                                        ...
                                        <div class="h_list_boding variants_item_file fn_file_wrap">
                                        ...
                                        {if !$variant@first}
                                            <div class="h_list_boding h_list_close remove_variant">
                            ...
                            {/foreach}
                            <div class="h_list_body_item variants_list_item fn_new_row_variant">
                                <div class="h_list_row ">
                                    <div class="h_list_boding variants_item_drag">
                                        <div class="heading_label"></div>
                                        <div class="move_zone">
                                ...
                                <div class="h_list_row">
                                    <div class="h_list_boding variants_item_drag"></div>
                                    <div class="h_list_boding variants_item_file">
                                        <div class="heading_label">{$btr->general_digital_product|escape}</div>
                                        <input type="file" name="attachment[]" />
                                        <input type="hidden" name="delete_attachment[]" />
    ...
    <div class="row">
        <div class="col-lg-8 col-md-12 pr-0 ">
            <div class="boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="toggle_body_wrap on fn_card h_disabled">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="boxed fn_toggle_wrap min_height_210px">
                ...
                <div class="toggle_body_wrap on fn_card fn_sort_list">
                    <div class="h_list ok_related_list">
                        <div class="h_list_body related_products sortable">
                            {foreach $related_products as $related_product}
                                <div class="fn_row h_list_body_item fn_sort_item">
                                    <div class="h_list_row">
                                        ...
                                        <div class="h_list_boding h_list_related_photo">
                                        ...
                                        <div class="h_list_boding h_list_related_name">
                            ...
                            {/foreach}
                            <div id="new_related_product" class="fn_row h_list_body_item fn_sort_item" style='display:none;'>
                                <div class="h_list_row">
                                    <div class="h_list_boding h_list_drag move_zone">
                                        {include file='svg_icon.tpl' svgId='drag_vertical'}
                                    </div>
            ...
            <div class="boxed match fn_toggle_wrap">
                ...
                <div class="toggle_body_wrap on fn_card row">
                    ...
                    <div class="col-lg-6 col-md-6 pl-0">
                        ...
                        <textarea name="meta_description" class="form-control h_textarea fn_meta_field">{$product->meta_description|escape}</textarea>
                    </div>
                </div>
            </div>
        </div>
