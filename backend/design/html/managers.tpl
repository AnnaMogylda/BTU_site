        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form method="post" class="fn_form_list">
                    ...
                    <div class="managers_wrap h_list">
                        {*Шапка таблицы*}
                        <div class="h_list_head">
                            ...
                            <div class="h_list_heading h_list_manager_name">{$btr->general_name|escape}</div>
                                ...
                                <div class="fn_row h_list_body_item">
                                    <div class="h_list_row">
                                        <div class="h_list_boding h_list_check">
                                            ...
                                            <label class="h_ckeckbox" for="id_{$manager_admin->id}"></label>
                                        </div>

                                        <div class="h_list_boding h_list_manager_name">
