        ...
        <form method="post" class="fn_form_list fn_fast_button">
            ...
            <div class="h_list products_list fn_sort_list">
                ...
                <div class="h_list_head">
                    <div class="h_list_heading h_list_subicon"></div>
                    ...
                    <div class="h_list_heading h_list_photo hidden-sm-down">{$btr->general_photo|escape}</div>
                    <div class="h_list_heading h_list_categories_name">{$btr->general_name|escape}</div>
                    <div class="h_list_heading h_list_status">{$btr->general_enable|escape}</div>
                    <div class="h_list_heading h_list_setting">{$btr->general_activities|escape}</div>
                    <div class="h_list_heading h_list_close"></div>
                </div>

                {*Параметры элемента*}
                <div class="h_list_body categories_wrap sortable ">
                {if $categories}
                        ...
                        <div class="fn_row h_list_body_item   fn_sort_item">
                            <div class="h_list_row ">
                                ...
                                {if $category->subcategories}
                                    <div class="h_list_heading h_list_subicon">
                                ...
                                <div class="h_list_boding h_list_check">
                                    ...
                                    <label class="h_ckeckbox" for="id_{$category->id}"></label>
                                </div>

                                <div class="h_list_boding h_list_photo hidden-sm-down">
                                    {if $category->image}
                                ...
                                <div class="h_list_boding h_list_categories_name">
