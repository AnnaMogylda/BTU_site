...
<div class="row">
    ...
    <div class="col-lg-2 col-md-3 col-sm-12 col-xs-12">
        <div class="wrap_heading wrap_head_mob float-sm-right">
            <a class="btn btn_blue btn_small" target="_blank" href="https://Home-cms.com/support">
            ...
            <div class="boxed fn_toggle_wrap ">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-1">
                            <textarea class="form-control h_textarea" name="accesses">{$accesses}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="h_list">
                                ...
                                <div class="h_list_head">
                                    <div class="h_list_heading h_list_topic_name">{$btr->general_name|escape}</div>
                                    <div class="h_list_heading h_list_topic_message">{$btr->topic_message|escape}</div>
                                    <div class="h_list_heading h_list_topic_time">{$btr->topic_spent_time|escape}</div>
                                </div>
                                {*Параметры элемента*}
                                <div class="h_list_body">
                                    ...
                                    <div class="fn_row h_list_body_item">
                                        <div class="h_list_row">
                                            <div class="h_list_boding h_list_topic_name">
                                            ...
                                            <div class="h_list_boding h_list_topic_message">
                                                {$comment->text}
                                            </div>

                                            <div class="h_list_boding h_list_topic_time {if $comment->spent_time < 0}text-success{/if}">
            ...
            <div class="boxed match fn_toggle_wrap tabs">
                ...
                <div class="toggle_body_wrap on fn_card row">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="comment_text" id="fn_editor" class="form-control h_textarea editor_small">{$topic_message|nl2br}</textarea>
                    </div>
