        ...
        {if $banners_images}
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form class="fn_form_list" method="post">
                    <div id="main_list" class=" h_list products_list fn_sort_list">
                        ...
                        <div class="h_list_head">
                            ...
                            <div class="h_list_heading h_list_brands_photo">{$btr->general_image|escape}</div>
                            <div class="h_list_heading h_list_bransimages_name">{$btr->general_name|escape}</div>
                            <div class="h_list_heading h_list_brands_group">{$btr->general_banner_group|escape}</div>
                            <div class="h_list_heading h_list_status">{$btr->general_enable|escape}</div>
                            <div class="h_list_heading h_list_close"></div>
                        </div>

                        {*Параметры элемента*}
                        <div class="banners_wrap h_list_body features_wrap sortable">
                                ...
                                <div class="fn_row h_list_body_item fn_sort_item">
                                    <div class="h_list_row">
                                        ...
                                        <div class="h_list_boding h_list_check">
                                            ...
                                            <label class="h_ckeckbox" for="id_{$banners_image->id}"></label>
                                        </div>

                                        <div class="h_list_boding h_list_brands_photo">
                                        ...
                                        <div class="h_list_boding h_list_bransimages_name">
                                            ...
                                            <div class="h_list_name_brand">
                                                {$banners_image->image}
                                            </div>
                                        </div>

                                        <div class="h_list_boding h_list_brands_group">
                                            {if $banners}
