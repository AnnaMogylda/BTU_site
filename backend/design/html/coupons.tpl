        ...
        <form class="fn_form_list" method="post">
            ...
            <div class="h_list products_list fn_sort_list">
                ...
                <div class="h_list_head">
                    ...
                    <div class="h_list_heading h_list_coupon_name">{$btr->coupons_name|escape}</div>
                    <div class="h_list_heading h_list_coupon_sale">{$btr->general_discount|escape}</div>
                    <div class="h_list_heading h_list_coupon_condit">{$btr->general_conditions|escape}</div>
                    <div class="h_list_heading h_list_coupon_validity">{$btr->coupons_terms|escape}</div>
                    <div class="h_list_heading h_list_coupon_disposable">{$btr->coupons_one_off|escape}</div>
                    <div class="h_list_heading h_list_coupon_count">{$btr->coupons_qty_uses|escape}</div>
                    <div class="h_list_heading h_list_close"></div>
                </div>
                {*Блок добавления нового элемента*}
                <div class="h_list_body fn_new_coupon">
                    <div class="h_list_body_item">
                        <div class="h_list_row ">
                            <div class="h_list_heading h_list_check"></div>
                            <div class="h_list_boding h_list_coupon_name">
                            ...
                            <div class="h_list_boding h_list_coupon_sale">
                            ...
                            <div class="h_list_boding h_list_coupon_disposable">
                                <input class="hidden_check" type="checkbox" name="new_single" id="single" value="1" />
                                <label class="h_ckeckbox" for="single"></label>
                            </div>
                            <div class="h_list_heading h_list_coupon_count"></div>
                            <div class="h_list_heading h_list_close"></div>
                        </div>
                    </div>
                </div>
                {*Параметры элемента*}
                <div class="h_list_body fn_coupon_wrap">
                    {foreach $coupons as $coupon}
                        <div class="fn_row h_list_body_item">
                            <div class="h_list_row ">
                                <div class="h_list_boding h_list_check">
                                    <input class="hidden_check" type="checkbox" id="id_{$coupon->id}" name="check[]" value="{$coupon->id}"/>
                                    <label class="h_ckeckbox" for="id_{$coupon->id}"></label>
                                </div>
                                <div class="h_list_boding h_list_coupon_name">
                                ...
                                <div class="h_list_boding h_list_coupon_count">
                                    {if $coupon->usages>0}
