                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group clearfix">
                                                        <div class="boxes_inline">
                                                            ...
                                                            <label class="h_ckeckbox" for="{$setting->variable}"></label>
                                                        </div>
                       ...
                       {foreach $deliveries as $delivery}
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="payment_item">
                                    ...
                                    <label for="id_{$delivery->id}" class="h_ckeckbox {if in_array($delivery->id, $payment_deliveries)}active_payment{/if}">
