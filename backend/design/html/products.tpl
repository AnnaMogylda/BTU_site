        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form method="post" class="fn_form_list fn_fast_button">
                    ...
                    <div class="h_list products_list fn_sort_list">
                        {*Шапка таблицы*}
                        <div class="h_list_head">
                            <div class="h_list_boding h_list_drag"></div>
                            <div class="h_list_heading h_list_check">
                                <input class="hidden_check fn_check_all" type="checkbox" id="check_all_1" name="" value="" />
                                <label class="h_ckeckbox" for="check_all_1"></label>
                            </div>
                            <div class="h_list_heading h_list_photo">{$btr->general_photo|escape}</div>
                            <div class="h_list_heading h_list_name">{$btr->general_name|escape} </div>
                            <div class="h_list_heading h_list_price">{$btr->general_price|escape}</div>
                            <div class="h_list_heading h_list_count">{$btr->general_qty|escape}</div>
                            <div class="h_list_heading h_list_status">{$btr->general_enable|escape}</div>
                            <div class="h_list_heading h_list_setting h_list_products_setting">{$btr->general_activities|escape}</div>
                            <div class="h_list_heading h_list_close"></div>
                        </div>
                        {*Параметры элемента*}
                        <div class="h_list_body sort_extended">
                            {foreach $products as $product}
                                <div class="fn_row h_list_body_item fn_sort_item">
                                    <div class="h_list_row">
                                        <input type="hidden" name="positions[{$product->id}]" value="{$product->position}">

                                        <div class="h_list_boding h_list_drag move_zone">
                                            {include file='svg_icon.tpl' svgId='drag_vertical'}
                                        </div>

                                        <div class="h_list_boding h_list_check">
                                            <input class="hidden_check" type="checkbox" id="id_{$product->id}" name="check[]" value="{$product->id}"/>
                                            <label class="h_ckeckbox" for="id_{$product->id}"></label>
                                        </div>
                                        <div class="h_list_boding h_list_photo">
                                            {if $product->image}
                                        ...
                                        <div class="h_list_boding h_list_name">
                                            ...
                                            {if $all_brands[$product->brand_id]->name}
                                                <div class="h_list_name_brand">{$btr->general_brand|escape} {$all_brands[$product->brand_id]->name|escape}</div>
                                            {/if}
                                        ...
                                        <div class="h_list_boding h_list_price">
                                            <div class="input-group">
                                        ...
                                        <div class="h_list_boding h_list_count">
                                            <div class="input-group">
                                        ...
                                        {*visible*}
                                        <div class="h_list_boding h_list_status">
                                        ...
                                        <div class=" h_list_setting h_list_products_setting">
                                        ...
                                        <div class="h_list_boding h_list_close">
                                            {*delete*}
                                    ...
                                    {*Если есть варианты товара*}
                                        <div class="h_list_variants products_variants_block">
                                        {foreach $product->variants as $variant}
                                            {if $variant@iteration > 1}
                                                <div class="h_list_row">
                                                    <div class="h_list_boding h_list_drag"></div>
                                                    <div class="h_list_boding h_list_check"></div>
                                                    <div class="h_list_boding h_list_photo"></div>
                                                    <div class="h_list_boding h_list_variant_name">
                                                    ...
                                                    <div class="h_list_boding h_list_status"></div>
                                                    <div class="h_list_setting h_list_products_setting">
                                                        {*feed*}
                                                    ...
                                                    <div class="h_list_boding h_list_close"></div>
                                                </div>
                                            {/if}
                                        {/foreach}
                                        </div>
                        ...
                        <div class="h_list_footer fn_action_block">
                            <div class="h_list_foot_left">
                                <div class="h_list_boding h_list_drag"></div>
                                <div class="h_list_heading h_list_check">
                                    <input class="hidden_check fn_check_all" type="checkbox" id="check_all_2" name="" value=""/>
                                    <label class="h_ckeckbox" for="check_all_2"></label>
                                </div>
                                <div class="h_list_option">
