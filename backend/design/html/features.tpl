        ...
        <form method="post" class="fn_form_list fn_fast_button">
            ...
            <div class="h_list products_list fn_sort_list">
                ...
                <div class="h_list_head">
                    ...
                    <div class="h_list_heading h_list_features_name">{$btr->general_name|escape}</div>
                    <div class="h_list_heading h_list_features_tag">{$btr->general_categories|escape}</div>
                    <div class="h_list_heading h_list_url_status">{$btr->feature_url_in_product_short|escape}</div>
                    <div class="h_list_heading h_list_status">{$btr->features_in_filter|escape}</div>
                    <div class="h_list_heading h_list_setting h_list_features_setting">{$btr->general_activities|escape}</div>
                    <div class="h_list_heading h_list_close"></div>
                </div>
                {*Параметры элемента*}
                <div class="h_list_body features_wrap sort_extended">
                    ...
                    <div class="fn_row h_list_body_item fn_sort_item">
                        <div class="h_list_row ">
                            ...
                            <div class="h_list_boding h_list_check">
                                ...
                                <label class="h_ckeckbox" for="id_{$feature->id}"></label>
                            </div>

                            <div class="h_list_boding h_list_features_name">
                                <a class="link" href="{url module=FeatureAdmin id=$feature->id return=$smarty.server.REQUEST_URI}">
                                    {$feature->name|escape}
                                </a>
                            </div>

                            <div class="h_list_boding h_list_features_tag">
                                <div class="wrap_tags">
                            ...
                            <div class="h_list_boding h_list_url_status">
                                {*url_in_product*}
                            ...
                            <div class="h_list_boding h_list_setting h_list_features_setting">
                                {*yandex*}
