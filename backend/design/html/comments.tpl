            ...
            <form class="fn_form_list" method="post">
                ...
                <div class="post_wrap h_list">
                    ...
                    <div class="h_list_head">
                        ...
                        <div class="h_list_heading h_list_comments_name">{$btr->general_comments|escape}</div>
                                ...
                                <div class="fn_row h_list_body_item {if $level > 0}admin_note2{/if}">
                                    <div class="h_list_row">
                                        ...
                                        <div class="h_list_boding h_list_check">
                                            ...
                                            <label class="h_ckeckbox" for="id_{$comment->id}"></label>
                                        </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal " method="post">
                    ...
                    <div class="form-group">
                        <textarea id="fn_comment_area" class="form-control h_textarea" placeholder="{$btr->general_enter_answer|escape}" name="text" rows="10" cols="50"></textarea>
                    </div>
