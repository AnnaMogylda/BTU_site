        ...
        <div class="col-xl-8 break_1300_12  pr-0">
            <div class="boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="">
                        <div id="fn_purchase" class="h_list">
                            {*Шапка таблицы*}
                            <div class="h_list_head">
                                <div class="h_list_heading h_list_photo">{$btr->general_photo|escape}</div>
                                <div class="h_list_heading h_list_order_name">{$btr->order_name_option|escape} </div>
                                <div class="h_list_heading h_list_price">{$btr->general_price|escape} {$currency->sign|escape}</div>
                                <div class="h_list_heading h_list_count">{$btr->order_qty|escape}
                                </div>
                                <div class="h_list_heading h_list_order_amount_price">{$btr->general_sales_amount}</div>
                            </div>
                            {*Список покупок*}
                            <div class="h_list_body">
                                {foreach $purchases as $purchase}
                                    <div class="fn_row h_list_body_item purchases">
                                        <div class="h_list_row">
                                            ...
                                            <div class="h_list_boding h_list_order_name">
                                                <div class="boxes_inline">
                                                    {if $purchase->product}
                                            ...
                                            <div class="h_list_boding h_list_order_amount_price">
                                                <div class="text_dark">
                            ...
                            <div class="h_list_body fn_new_purchase" style="display: none">
                            ...
                            <div class="h_list">
                                <div class="h_list_body">
                                    <div class="h_list_body_item">
                                        <div class="h_list_row  d_flex">
                                            <div class="h_list_boding h_list_ordfig_name">
                                                <div class="text_600 text_dark">{$btr->general_discount|escape}</div>
                                            </div>
                                            <div class="h_list_boding h_list_ordfig_val">
                                                <div class="input-group">
                                            ...
                                            <div class="h_list_boding h_list_ordfig_price">
                                                <div class="text_dark">
