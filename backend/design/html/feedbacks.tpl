                ...
                <form method="post" class="fn_form_list">
                    ...
                    <div class="post_wrap h_list">
                        ...
                        <div class="h_list_head">
                            ...
                            <div class="h_list_heading h_list_comments_name">{$btr->general_messages|escape}</div>
                            <div class="h_list_heading h_list_comments_btn"></div>
                        ...
                        <div class="h_list_body">
                            {function name=comments_tree level=0}
                                {foreach $feedbacks as $feedback}
                                    <div class="fn_row h_list_body_item {if $level > 0}admin_note2{/if}">
                                        <div class="h_list_row">
                                            <div class="h_list_boding h_list_check">
                                                ...
                                                <label class="h_ckeckbox" for="id_{$feedback->id}"></label>
                                            </div>

                                            <div class="h_list_boding h_list_comments_name {if $level > 0}admin_note{/if}">
                                                <div class="h_list_text_inline mb-q mr-1">
                                                    <span class="text_dark text_bold">{$btr->general_name|escape} </span> {$feedback->name|escape}
                                                </div>
                                                <div class="h_list_text_inline mb-q">
                                                    <span class="text_dark text_bold">{$btr->general_phone}: </span> {$feedback->phone|escape}
                                                </div>
                                                <div class="h_list_text_inline mb-q">
                                                    <span class="text_dark text_bold">Email: </span> {$feedback->email|escape}
                                                </div>
                                                <div class="mb-q">
                                                    <span class="text_dark text_bold">{$btr->general_from|escape} </span>
                                                     {$feedback->from_place|escape|nl2br}
                                                </div>
                                                <div class="mb-q">
                                                    <span class="text_dark text_bold">{$btr->general_dest|escape} </span>
                                                     {$feedback->to_place|escape|nl2br}
                                                </div>
                                                <div class="mb-q">
                                                    <span class="text_dark text_bold">{$btr->general_date|escape} </span>
                                                     {$feedback->to_date|escape|nl2br}
                                                </div>
                                                <div class="mb-q">
                                                    <span class="text_dark text_bold">{$btr->general_passengers|escape} </span>
                                                     {$feedback->passengers|escape|nl2br}
                                                </div>
                                                <div>
                                            ...
                                            <div class="h_list_boding h_list_comments_btn">
                                                {if !$feedback->processed}
                                                    <button type="button" class="btn btn_small btn-outline-warning fn_ajax_action {if $feedback->processed}fn_active_class{/if}" data-module="feedback" data-action="processed" data-id="{$feedback->id}" onclick="$(this).hide();">
                                                        {$btr->general_process|escape}
                                                    </button>
            ...
            <div class="modal-body">
                <form class="form-horizontal " method="post">
                    ...
                    <div class="form-group">
                        <textarea class="fn_comment_area form-control h_textarea" placeholder="{$btr->general_enter_answer|escape}" name="text" rows="10" cols="50"></textarea>
                    </div>
