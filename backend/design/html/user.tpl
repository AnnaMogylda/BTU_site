    ...
    <div class="row">
        <div class="col-md-12">
            <div class="boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="">
                        <div class="h_list products_list">
                            <div class="h_list_head">
                                <div class="h_list_heading h_list_user_number">№ </div>
                                <div class="h_list_heading h_list_user_name">{$btr->general_full_name|escape}</div>
                                <div class="h_list_heading h_list_user_date">{$btr->general_date|escape}</div>
                                <div class="h_list_heading h_list_user_price">{$btr->coupons_order_price|escape}</div>
                            </div>
                            <div class="h_list_body">
                                {foreach $orders as $order}
                                    <div class="fn_row h_list_body_item">
                                        <div class="h_list_row">
                                            <div class="h_list_boding h_list_user_number">
                                                <a href="{url module=OrderAdmin id=$order->id return=$smarty.server.REQUEST_URI}">{$btr->general_order_number|escape} {$order->id}</a>
                                            </div>
                                            <div class="h_list_boding h_list_user_name">
                                            ...
                                            <div class="h_list_boding h_list_user_date">
                                                <div>{$order->date|date} | {$order->date|time}</div>
                                            </div>

                                            <div class="h_list_boding h_list_user_price">
