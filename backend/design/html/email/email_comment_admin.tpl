        ...
        <tr>
            <td border="0" align="left" style="border: 0">
                <div>
                    <div>
                        <div>
                            <div data-type="info-region" style="text-align: center; font-family: 'Trebuchet MS'; font-size: 11px; color: rgb(51, 51, 51); line-height: normal">{$btr->email_details|escape}</div>
                        </div>
                    </div>
                </div>
            </td>
