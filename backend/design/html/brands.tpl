        ...
        <form method="post" class="fn_form_list fn_fast_button">
            ...
            <div class="h_list products_list fn_sort_list">
                ...
                <div class="h_list_head">
                    ...
                    <div class="h_list_heading h_list_brands_name">{$btr->general_name|escape}</div>
                        ...
                        <div class="fn_row h_list_body_item fn_sort_item">
                            <div class="h_list_row ">
                                ...
                                <div class="h_list_boding h_list_check">
                                    ...
                                    <label class="h_ckeckbox" for="id_{$brand->id}"></label>
                                </div>
                                ...
                                <div class="h_list_boding h_list_brands_name">
                                    <a href="{url module=BrandAdmin id=$brand->id return=$smarty.server.REQUEST_URI}">
                                        {$brand->name|escape}
                                    </a>
                                </div>
