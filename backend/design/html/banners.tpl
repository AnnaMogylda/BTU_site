            ...
            <form class="fn_form_list" method="post">
                ...
                <div class="h_list products_list fn_sort_list">
                    ...
                    <div class="h_list_head">
                        ...
                        <div class="h_list_heading h_list_features_name">{$btr->banners_group_name|escape}</div>
                        <div class="h_list_heading h_list_brands_tag">{$btr->banners_display|escape}</div>
                        <div class="h_list_heading h_list_status">{$btr->general_enable|escape}</div>
                        <div class="h_list_heading h_list_close"></div>
                    </div>
                    {*Параметры элемента*}
                    <div class="banners_groups_wrap h_list_body features_wrap sortable">
                        ...
                        <div class="fn_row h_list_body_item fn_sort_item">
                            <div class="h_list_row">
                                ...
                                <div class="h_list_boding h_list_check">
                                    ...
                                    <label class="h_ckeckbox" for="id_{$banner->id}"></label>
                                </div>
                                ...
                                <div class="h_list_boding h_list_brands_tag">
                                    <div class="wrap_tags">
