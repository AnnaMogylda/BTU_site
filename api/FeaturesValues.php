...
class FeaturesValues extends Home {
    ...
    public function get_features_values($filter = array(), $count = false) {
         ...
         * таким образом на странице https://demoHome.com/catalog/gadzhety/seriya-redminote4_redmi3s/razreshenieekrana-1080x1920piks
